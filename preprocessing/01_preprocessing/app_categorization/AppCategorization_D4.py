...
This script categorizes apps from KeyEvent.csv files using web scraping.
...
def update_user_files():
    """Update each user's KeyEvent.csv with the new app categories."""
    print("\n" + "=" * 50)
...
def main():
    ...
    print("D-4 App Categorization Script")
    print("=" * 50)
    
    # Step 1: Collect app packages
