...
DEFAULT_TZ = pytz.FixedOffset(540)  # Study timezone (UTC+09:00)

# === Path configuration =====================================================
# Override via environment variables; otherwise edit the defaults below
# to point at your local copy of the dataset and project workspace.
#   DATA_ROOT     : directory holding SubjData/ and newdata/ for this dataset
#   PROJECT_ROOT  : workspace where intermediates and results are written
DATA_ROOT    = os.environ.get('DATA_ROOT',    '<DATA_ROOT>')      # e.g. /path/to/dataset_D2
PROJECT_ROOT = os.environ.get('PROJECT_ROOT', '<PROJECT_ROOT>')   # e.g. /path/to/workspace_D2
...
PATH_SAVE = os.path.join(PROJECT_ROOT, 'Intermediate/Save/')
PATH_SAVE_STEPS = os.path.join(PROJECT_ROOT, 'Intermediate/Save_Steps/')
PATH_SAVE_CALORIES = os.path.join(PROJECT_ROOT, 'Intermediate/Save_CALORIES/')
PATH_SAVE_COMBI = os.path.join(PROJECT_ROOT, 'Intermediate/Save_COMBI/')

PATH_INTERMEDIATE_HOURLY_INTERPRETABLE = os.path.join(PROJECT_ROOT, 'Intermediate/hourly_data_interpretable')
PATH_INTERMEDIATE_HOURLY_ALL = os.path.join(PROJECT_ROOT, 'Intermediate/hourly_data_all')


PATH_INTERMEDIATE = os.path.join(PROJECT_ROOT, 'Intermediate')
RANDOM_STATE =42
